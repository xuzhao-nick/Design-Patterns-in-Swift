...
let vickiPoodle = Product(identifier: "product-002", name: "Vicki's prize poodle", cost: 1000)
...
let customer = Customer(identifier: "customer-001", address: "1234 My Street Somewhereville, TX, USA", name: "Johnny Appleseed")
